        ...
        <div className="relative flex items-center">
          ...
          {search && (
            <button
              type="button"
              onClick={() => setSearch('')}
              className="absolute right-3.5 flex h-7 w-7 items-center justify-center rounded-full bg-ink/5 text-ink/60 hover:bg-ink/10 hover:text-ink transition-colors"
      ...
      {filteredItems.length > 0 ? (
        ...
        <div className="rounded-2xl border border-dashed border-ink/20 bg-paper/50 p-10 text-center">
          ...
          <button
            ...
            className="mt-5 inline-flex items-center gap-2 rounded-full border border-ink/20 bg-white px-5 py-2 text-xs font-semibold uppercase tracking-wider text-ink transition-colors hover:border-ink hover:bg-ink hover:text-white"
          >
